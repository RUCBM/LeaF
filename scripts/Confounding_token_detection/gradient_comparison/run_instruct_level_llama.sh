...
FILE_PATH="data/llama_1b_gradient_data/Numina_train_data_llama_1b_1.2w.json"
...
# 运行 Python 脚本，并传入参数
python src/Confounding_token_detection/run_gradients_llama_instruct_level.py \
    --file_path "$FILE_PATH" \
